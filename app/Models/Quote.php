...
class Quote extends Model
{
    ...
    protected $fillable = ['user_id', 'service_id','service_name','detail','status','category_id','phone', 'whatsapp', 'location','affiliate_id', 'sourcing_quantity','bid_id','zone','source'];
