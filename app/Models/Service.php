...
{
    protected $fillable = ['name', 'image', 'description', 'price', 'duration', 'category_id', 'short_description', 'discount', 'status', 'type','quote','pipelineId','meta_title', 'meta_description', 'meta_keywords', 'slug','feature','viewed'];
