...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::post('serviceStaff/{id}/social-links/update', [ServiceStaffController::class, 'updateServicesStaffSocialLinks'])->name('serviceStaff.social-links.update');
    Route::get('serviceStaff/{id}/gallery', [ServiceStaffController::class, 'ServicesStaffGallery'])->name('serviceStaff.gallery');
    Route::post('serviceStaff/{id}/gallery/update', [ServiceStaffController::class, 'updateServicesStaffGallery'])->name('serviceStaff.gallery.update');
    Route::get('serviceStaff/{id}/categories-and-services', [ServiceStaffController::class, 'ServicesStaffCategoriesAndServices'])->name('serviceStaff.categories-and-services');
    Route::post('serviceStaff/{id}/categories-and-services/update', [ServiceStaffController::class, 'updateServicesStaffCategoriesAndServices'])->name('serviceStaff.categories-and-services.update');
    Route::get('serviceStaff/{id}/documents', [ServiceStaffController::class, 'ServicesStaffDocuments'])->name('serviceStaff.documents');
    Route::post('serviceStaff/{id}/documents/update', [ServiceStaffController::class, 'updateServicesStaffDocuments'])->name('serviceStaff.documents.update');
...
Route::get('/autocomplete-name', [UserController::class, 'autocompleteName'])->name('autocomplete.name');
Route::get('/autocomplete-category', [ServiceCategoryController::class, 'autocomplete'])->name('autocomplete.category');
