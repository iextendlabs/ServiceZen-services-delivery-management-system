                        ...
                        <form action="{{ route('complaints.update', $complaint->id) }}" method="POST">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-8">
                                    ...
                                    <input type="text" name="title" value="{{ old('title', $complaint->title ) }}" class="form-control form-control-lg" placeholder="Title" />
                                </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-12">
                                    ...
                                    <textarea name="description" class="form-control" rows="6">{{ old('description',$complaint->description) }}</textarea>
                                </div>
                            </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select name="user_id" class="form-control">
                                        ...
                                        @foreach ($users as $user)
                                            <option value="{{ $user->id }}" {{ old('user_id', $complaint->user_id) == $user->id ? 'selected' : '' }}>{{ $user->name }} | {{ $user->email }}</option>
                                        @endforeach
                                    </select>
                                </div>
