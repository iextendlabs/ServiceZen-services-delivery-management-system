            ...
            <div class="card-body">
                ...
                <form action="{{ route('reviews.update',$review->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <span style="color: red;">*</span><strong>Rating</strong>
                                <div>
                                    @for($i = 1; $i <= 5; $i++)
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" style=" height:220px" name="content" placeholder="Write your review...">{{ old("content",$review->content) }}</textarea>
                            </div>
                        </div>

                        <!-- Feature toggle (left) and Images (right) -->
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="form-check form-switch">
                                        ...
                                        <input class="form-check-input ml-1" type="checkbox" name="feature" id="feature" value="1"
                                            {{ old('feature',$review->feature) == '1' ? 'checked' : '' }}>
                                        <label class="form-check-label ml-5" for="feature">Enable featured review</label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-8">
                                <div class="form-group">
                                    <div class="d-flex justify-content-between align-items-start">
                                        ...
                                        <small class="text-muted">Add one or more images (JPEG, PNG). Preview shown below.</small>
                                    </div>
                                    <table id="imageTable" class="table mt-2">
                                        <thead>
                                            <tr>
                                    ...
                                    <div class="text-right">
                                        <button id="addImageBtn" type="button" class="btn btn-primary">+ Add Image</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="video"><strong>Upload video</strong></label>
