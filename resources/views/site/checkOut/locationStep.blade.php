    ...
    <div class="album bg-light py-4">
        <div class="container">
                        ...
                        <div class="location-search-left">
                            <svg width="12" height="18" viewBox="0 0 12 18" fill="none"
                                ...
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    d="M0 6.2468C0 2.80246 2.69144 0 5.99974 0C9.30812 0 12 2.80246 12 6.2468C12 9.56227 6.55647 17.3084 6.32455 17.6364L6.10836 17.9429C6.0828 17.9789 6.04277 18 5.99974 18C5.95736 18 5.91707 17.9789 5.89177 17.9429L5.67545 17.6364C5.44367 17.3084 0 9.56227 0 6.2468ZM8.149 6.2468C8.149 5.01276 7.18511 4.00921 5.99974 4.00921C4.81502 4.00921 3.85047 5.01276 3.85047 6.2468C3.85047 7.48021 4.81506 8.4844 5.99974 8.4844C7.18507 8.4844 8.149 7.48021 8.149 6.2468Z"
                                    fill="black" fill-opacity="0.87"></path>
                            </svg>
                        </div>
                        <div class="location-search-input-wrapper">
                            <input id="searchField" type="text" name="searchField"
                                placeholder="Search for area, street name, landmark..." autocomplete="on"
                                value="{{ old('searchField') ? old('searchField') : $address['searchField'] }}"
            ...
            <form action="addressSession" method="POST">
                @csrf
                <input id="searchField" type="hidden" name="searchField"
                    placeholder="Search for area, street name, landmark..." autocomplete="on"
                    value="{{ old('searchField') ? old('searchField') : $address['searchField'] }}"
                    class="location-search-input">
                <div class="row">
                    ...
                    <input type="hidden" name="latitude" id="latitude" class="form-control" placeholder="latitude"
                        value="{{ old('latitude') ? old('latitude') : $address['latitude'] }}">
                    <input type="hidden" name="longitude" id="longitude" class="form-control" placeholder="longitude"
                        value="{{ old('longitude') ? old('longitude') : $address['longitude'] }}">
                </div>
                ...
                <div class="col-md-12 text-center">
                    <button type="submit" class="btn btn-block btn-success mb-2 mt-2">Next</button>
                    <a href="bookingStep">
