    ...
    <div class="row">
        ...
        <div class="col-md-12 mb-3 no-print">
            <div class="d-flex flex-wrap justify-content-md-end">
                ...
                <a class="btn btn-success mb-2" href="{{ route('orders.edit', $order->id) }}?edit=booking">Booking Edit</a>
                @endcan
                ...
                <a class="btn btn-warning mb-2 ms-md-2" href="{{ route('orders.edit', $order->id) }}?edit=address">Address Edit</a>
                @endcan
                @can('order-affiliate-edit')
                <a class="btn btn-primary mb-2 ms-md-2" href="{{ route('orders.edit', $order->id) }}?edit=affiliate">Affiliate Edit</a>
                @endcan
                @can('order-comment-edit')
                <a class="btn btn-success mb-2 ms-md-2" href="{{ route('orders.edit', $order->id) }}?edit=comment">Comment Edit</a>
                @endcan
                <a class="btn btn-secondary mb-2 ms-md-2" href="{{ route('orders.edit', $order->id) }}?edit=services">Edit Services</a>
                @can('order-driver-status-edit')
                <a class="btn btn-success mb-2 ms-md-2" href="{{ route('orders.edit', $order->id) }}?edit=order_driver_status">Order Driver Status Edit</a>
                <a class="btn btn-primary mb-2 ms-md-2" href="{{ route('orders.edit', $order->id) }}?edit=driver">Order Driver Edit</a>
                @endcan
                <a class="btn btn-secondary mb-2 ms-md-2" href="{{ route('orders.edit', $order->id) }}?edit=custom_location">Add Custom Location</a>
                @if($order->customer_id)
                <a class="btn btn-info mb-2 ms-md-2" href="{{ route('customers.show',$order->customer_id) }}">View Customer</a>
                @endif
                @can('order-download')
                <button type="button" class="btn btn-primary mb-2 ms-md-2" onclick="printDiv()"><i class="fa fa-print"></i>Download PDF</button>
                @endcan
            </div>
        </div>
    </div>
