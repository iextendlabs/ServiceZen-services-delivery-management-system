        ...
        <div class="row">
            <div class="col-md-12 margin-tb">
                <div class="float-start">
                    <h2>Affiliate ({{ $total_affiliate }})</h2>
                </div>
                <div class="float-end">
                            ...
                            <tr>
                                ...
                                <td>
                                    <form id="deleteForm{{ $affiliate->id }}"
                                        ...
                                        <a class="btn btn-warning" href="{{ route('affiliates.show', $affiliate->id) }}"><i
                                                class="fa fa-eye"></i></a>
                                        @can('affiliate-edit')
                                            <a class="btn btn-primary" href="{{ route('affiliates.edit', $affiliate->id) }}"><i
